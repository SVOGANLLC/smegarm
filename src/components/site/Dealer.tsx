...
export function Dealer() {
  const { t } = useI18n();
  return (
    <section id="dealer" className="site-section">
      <div className="mx-auto grid max-w-[1400px] grid-cols-1 gap-10 px-4 md:grid-cols-12 md:gap-12 md:px-10">
        ...
        <Reveal className="md:col-span-7">
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
            ...
            <div className="relative aspect-[4/3] overflow-hidden rounded-sm border border-border bg-secondary lg:aspect-auto lg:min-h-[280px]">
              <iframe
