...
export function WhatsAppFab() {
  ...
  if (pathname.startsWith("/admini") || pathname.startsWith("/admin/")) return null;
  return (
    <a
      ...
      className="fixed bottom-[max(1rem,env(safe-area-inset-bottom))] right-4 z-40 flex h-12 w-12 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg transition-transform active:scale-95 md:bottom-6 md:right-6 md:h-14 md:w-14 md:hover:scale-105"
    >
