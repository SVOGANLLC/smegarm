...
const main = [
  { img: fridge, key: "Refrigerators", count: "24" },
  { img: oven, key: "Ovens", count: "31" },
  { img: hob, key: "Hobs & Cooktops", count: "18" },
];

const small = ["Kettles", "Toasters", "Coffee machines", "Blenders", "Mixers", "Juicers", "Food processors"];
            ...
            <Reveal key={c.key} delay={i * 0.08}>
              ...
              >
                ...
                <div className="absolute inset-x-0 bottom-0 flex items-end justify-between p-6 text-background md:p-8">
                  <div>
                    <p className="text-[10px] uppercase tracking-[0.28em] opacity-70">{c.count} models</p>
                    <h3 className="mt-2 font-serif text-2xl md:text-3xl">{c.key}</h3>
                  </div>
